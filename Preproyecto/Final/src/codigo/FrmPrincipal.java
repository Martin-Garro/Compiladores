...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void btnAnalizarSinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnalizarSinActionPerformed
        ...
        Object peperesultado1 = null;
        try {
            
            /*
            txtAnalizarSin.setText("Analisis realizado correctamente\n");
            txtAnalizarSin.setForeground(new Color(25, 111, 61));
            txtAnalizarSin.setText(((Arbol) peperesultado1).toString());
            ((Arbol) peperesultado1).checkType(); 
            txtAnalizarSin.setText("CHEQUEO DE TIPOS:\n " + ((Arbol) peperesultado1).getResultado());            
             
            
            txtAnalizarSin.setText("EVALUADOR:\n " + ((Arbol) peperesultado1).getResultado() + ((Arbol) peperesultado1).getInfo().getOffset());
            ((Arbol) peperesultado1).getCodigo();
            
            */
            
            // Llamar al método parse() y obtener el árbol sintáctico
            peperesultado1 = s.parse().value;  
            
            // Obtener el resultado del chequeo de tipos
            String resultadoCheckType = ((Arbol) peperesultado1).getResultado();
            
            // Obtener el resultado del evaluador
            String resultadoEvaluador = ((Arbol) peperesultado1).getResultado() + ((Arbol) peperesultado1).getInfo().getOffset();
            
            // Obtener el código ensamblador
            String codigoEnsamblador = ((Arbol) peperesultado1).getCodigo();
            
            // Mostrar los resultados
            txtAnalizarSin.setText("Analisis realizado correctamente\n");
            txtAnalizarSin.setForeground(new Color(25, 111, 61));
            txtAnalizarSin.setText(peperesultado1.toString());
