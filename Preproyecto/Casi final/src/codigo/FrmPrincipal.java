...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    try {
        ...
        txtAnalizarSin.append("\n" + ((Arbol) peperesultado1).toString());
        ((Arbol) peperesultado1).checkType(); 
        txtAnalizarSin.append("\nChequeo de tipos: " + ((Arbol) peperesultado1).getResultado());
        ((Arbol) peperesultado1).evaluador(); 
        txtAnalizarSin.append("\nEvaluador: " + ((Arbol) peperesultado1).getResultado() + ((Arbol) peperesultado1).getInfo().getOffset());
        txtAnalizarSin.append("\n------------------------------------------------------\n");
        // Generar código ensamblador
        String codigoEnsamblador = ((Arbol) peperesultado1).getCodigo(); 
         // Mostrar el código en el JTextArea
        txtAnalizarSin.append("\nCodigo Ensamblador:\n" + codigoEnsamblador);

        } catch (Exception ex) {
            txtAnalizarSin.setText("Chequeo de tipos" + ((Arbol) peperesultado1).getResultado());
